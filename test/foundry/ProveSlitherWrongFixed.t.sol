...
contract ProveSlitherWrongFixed is Test {
    ...
    function test_fee_tokens_require_post_call_accounting() public {
        ...
        vm.prank(user1);
        (uint256 ethBalance, Lockx.erc20Balances[] memory erc20s, ) = lockx.getFullLockbox(user1TokenId);
     ...
     */
    function test_all_withdrawal_functions_have_reentrancy_guard() public {
        // We've proven that:
