...
contract LockxAbsolute100Coverage is Test {
    ...
    function test_lockx_100_percent() public {
        ...
        // Test burnLockbox - first withdraw ERC20 from tokenId2 (contains 1000e18 tokenA)
    ...
    function test_signatureVerification_100_percent() public {
        ...
        // Test _purgeAuth through burn - first withdraw ETH from tokenId (contains 10 ether)
        currentNonce = _getCurrentNonce(tokenId);
