...
async function main() {
  ...
  console.log('🚀 Deploying Lockx v2.0.0 with OpenZeppelin v5...');
  ...
  console.log(`npx hardhat verify --network ${process.env.HARDHAT_NETWORK || 'localhost'} ${contractAddress}`);
  
  console.log('\n📋 Deployment Summary:');
  console.log('Contract: Lockx v2.0.0');
